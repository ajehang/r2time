...
startdate ='2014/01/19-00:00:00' ## Start date and time of timeseries
...
jars=c("/home/bikash/tmp/r2time.jar","/home/bikash/tmp/zookeeper.jar", "/home/bikash/tmp/hbase.jar")
...
map <- expression({
    ...
    lapply(seq_along(map.values), function(r) {
        v <- r2t.toFloat(map.values[[r]][[1]][[1]])
    	k<-r2t.toInt(c(map.keys[[r]][[4]],map.keys[[r]][[5]],map.keys[[r]][[6]],map.keys[[r]][[7]]))
        rhcollect(k, v)
    })
})
